Shader "CustomRenderPipeline/DeferredLitCloth"
{
    Properties
    {
        ...
        [HideInInspector]_Anisotropy("Anisotropy Level", Range(0.0,1.0)) = 1.0

        [HDR]_FuzzColorClothLv("FuzzColor|ClothLv", Color) = (1,1,1,1)
    ...
    SubShader
    {
        ...
        Pass
        {
           ...
           ZTest Equal
            ...
            #pragma fragment GBufferClothFrag
